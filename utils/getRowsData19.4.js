 ...
 * Update 19.1
 *  -- Add parameters.log to getRowsData()
 * Update 19.2 (02.26.21)
 *  -- Add parameters.log to getHeaderColumn()
 *  -- Add parameters.debug to setRowsData()
 * Update 19.3 (03.20.21)
 *  -- Change writeMethod: 'append' to use .appendRow() so it's atomic
 * Update 19.4 (04.13.21)
 *  -- Make 'log' default to true
 */ 
...
function getRowsData(sheet, range, parameters) {
  ...
  var objects = getObjects_(values, keys, parameters.getBlanks, parameters.getMetadata, dataRange.getRowIndex(), base);
